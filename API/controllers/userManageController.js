...
export const getUsers = async (req, res) => {
  try {
    ...
    // Ensuring only non-admin users are fetched
    const query = { isAdmin: false }; // Always exclude admins

    if (department) {
      query.department = department; // Apply department filter if provided
    }
