...
const UserAccs = () => {
  ...
  const [formData, setFormData] = useState({ firstname: "", lastname: "", email: "", department: "", password: "", isAdmin: false, isVerified: true });
  ...
  const handleCreate = async () => {
    ...
    try {
      await axios.post('http://localhost:4000/api/user-manage/create', formData, {
        headers: { Authorization: `Bearer ${token}` }
      });
      toast.success("User created successfully");
      fetchUsers();
      setFormData({ firstname: "", lastname: "", email: "", department: "", password: "", isAdmin: false, isVerified: true });
    } catch (error) {
        ...
        <div className="md:w-1/2 bg-white p-4 rounded shadow-md">
          ...
          <form onSubmit={handleFormSubmit} className="mb-4 space-y-4">
            ...
            <select
              ...
              className={`input mb-2 p-2 border rounded w-full ${errors.department ? 'border-red-500' : ''}`}
            >
