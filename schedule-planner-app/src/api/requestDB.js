...
const CreateShiftRequest = async (shiftData) => {
  try {
    ...
    const response = await axios.post(
      `http://localhost:4000/api/request-shift/create-request`,
      requestData,
      {
        headers: {
...
const ApprovedRequest = async (RequestData) => {
  try {
    ...
    const response = await axios.put(
      "http://localhost:4000/api/request-shift/approved-request",
      RequestData,
      {
        headers: {
          "Content-Type": "application/json",
...
const RejectedRequest = async (RequestData) => {
  try {
    const token = localStorage.getItem("accessToken");
    const response = await axios.put(
      "http://localhost:4000/api/request-shift/rejected-request",
      RequestData,
      {
        headers: {
          "Content-Type": "application/json",
...
const GetRequest = async (userId) => {
  try {
    ...
    const response = await axios.get(
      `http://localhost:4000/api/request-shift/${userId}`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
...
const GetAllRequest = async (userId) => {
  try {
    ...
    const response = await axios.get(
      `http://localhost:4000/api/request-shift/`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
