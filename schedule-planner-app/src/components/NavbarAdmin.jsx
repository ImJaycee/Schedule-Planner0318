  ...
  const navlinks = [
    {
      link: "/admin/homepage",
      label: "Home",
      icon: <FaHome className='mr-3 text-blue-900' />,
    },
    {
      link: "/admin/manage-shift",
      label: "Manage Shift",
      icon: <FaRegCalendar className='mr-3 text-blue-900' />,
    },
    {
      link: "/admin/request-shift",
      label: "Requests",
      icon: <FaClipboardList className='mr-3 text-blue-900' />,
    },
    {
      link: "/admin/request-shift/swaps",
      label: "Shift Swap",
      icon: <FaExchangeAlt className='mr-3 text-blue-900' />,
    },
    {
      link: "/admin/announcement",
      label: "Announcement",
      icon: <FaBullhorn className='mr-3 text-blue-900' />,
    },
    {
      link: "/admin/profile",
      label: "Profile",
      icon: <FaUser className='mr-3 text-blue-900' />,
    },
    {
      link: "/admin/user-accounts",
      label: "User Accounts",
      icon: <FaUserFriends className='mr-3 text-blue-900' />,
    },
  ];
      ...
      >
        <div>
          ...
          <h5 className='text-xl font-semibold text-gray-900 mb-4'>
            {location.pathname === "/admin/homepage"
              ? "Home"
              : location.pathname === "/admin/manage-shift"
              ? "Manage Shift"
              : location.pathname === "/admin/request-shift"
              ? "Requests"
              : location.pathname === "/admin/request-shift/swaps"
              ? "Shift Swap"
        ...
        <div className='relative mt-6'>
          ...
          >
            ...
            <FaChevronDown
              className={`ml-3 text-gray-600 transition-transform duration-300 ${
                isDropdownOpen ? "rotate-180" : ""
              }`}
            />
          </div>
          <div
            className={`absolute bottom-full mb-2 bg-white shadow-lg rounded-lg w-full transition-all duration-300 ease-in-out ${
              isDropdownOpen
