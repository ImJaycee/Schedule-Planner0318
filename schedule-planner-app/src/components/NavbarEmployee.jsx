  ...
  return (
    <div className='flex md:h-screen bg-gray-100'>
      ...
      <div
        ...
        } md:translate-x-0 transition-transform duration-300 ease-in-out z-5`}
      >
        <div>
          {/* Close Button (Mobile) */}
          <button
          ...
          <h5 className='text-xl font-semibold text-gray-900 mb-4'>
            {location.pathname === "/homepage"
              ? "Home"
              : location.pathname === "/request-shift"
              ? "Request Shift"
              : location.pathname === "/request-shift-swap"
              ? "Request Swap"
