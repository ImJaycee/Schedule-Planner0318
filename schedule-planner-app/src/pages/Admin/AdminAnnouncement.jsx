...
const AdminAnnouncement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put(
          `http://localhost:4000/api/announcements/${editId}`,
            ...
            <div className='flex flex-col sm:flex-row gap-2'>
              ...
              {isEditing && (
                <button
                  ...
                  className='w-full sm:w-auto p-2 bg-red-500 text-white rounded hover:bg-gray-600'
                >
                  Cancel
                </button>
              )}
            ...
            {currentAnnouncements.map((announcement) => {
              ...
              return (
                <div
                  ...
                  className='bg-white p-4 mb-4 border rounded-lg shadow'
                >
