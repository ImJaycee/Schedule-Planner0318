...
const UserAccs = () => {
  ...
  const fetchUsers = async () => {
    try {
      const { data } = await axios.get(
        `http://localhost:4000/api/user-manage/users`,
        {
  ...
  const handleCreate = async () => {
    ...
    try {
      await axios.post(
        "http://localhost:4000/api/user-manage/create",
        { ...formData, department },
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await axios.put(
        `http://localhost:4000/api/user-manage/update/${formData._id}`,
        updatedData,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleDeactivate = async (id) => {
    try {
      await axios.put(
        `http://localhost:4000/api/user-manage/deactivate/${id}`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleActivate = async (id) => {
    try {
      await axios.put(
        `http://localhost:4000/api/user-manage/activate/${id}`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
