...
import { ApprovedRequest, CreateShiftRequest, RejectedRequest } from "../../api/requestDB";
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray bg-opacity-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <p><strong>Shift Type:</strong> {request.shiftType}</p>
        <p><strong>Start Time:</strong> {request.startTime}</p>
        <p><strong>End Time:</strong> {request.endTime}</p>
        <p><strong>Status:</strong> {request.status}</p>
        <p><strong>User Message:</strong> {request.userMessage}</p>
