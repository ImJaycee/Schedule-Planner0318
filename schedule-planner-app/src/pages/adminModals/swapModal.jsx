  ...
  return (
    <div className='fixed inset-0 flex items-center justify-center bg-gray bg-opacity-50'>
      <div className='bg-white p-6 rounded-lg shadow-lg w-96'>
        ...
        <p>
          <strong>Requester Message:</strong> {request.requesterMessage}
        </p>
        <p>
          <strong>Requested To:</strong> {request.requestedTo.firstname}{" "}
          {request.requestedTo.lastname}
        </p>
        <p>
          <strong>Shift:</strong>{" "}
          {new Date(request.requestingShiftId.date).toLocaleDateString()} -{" "}
          {request.RecipientST}
        </p>
        <p>
          <strong>Recipient Message:</strong> {request.recipientMessage}
        </p>
