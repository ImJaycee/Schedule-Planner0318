...
const UserShiftModal = ({ isOpen, onClose, shifts }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
        ...
        {shifts.length > 0 ? (
  shifts.some(shift => shift.employees !== "None") ? ( // Check if any shift is green
    shifts.map((shift, index) => (
      shift.color === "green" ? ( // Render only morning shifts
